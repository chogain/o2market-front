...
export default async function Header() {
  ...
  header.innerHTML = `
    <div class="inner">
      ...
      <ul class="main-menu">
        <li class="item">
          <div class="item__name vegetable"><a href="../../pages/product-list/index.html">채소</a></div>
        ...
        <li class="item">
          <div class="item__name fruit"><a href="../../pages/product-list/index.html">과일</a></div>
          <div class="item__contents">
            <div class="contents__menu">
              <ul class="inner">
                <li>
...
`;
  ...
  const vegetableProducts = vegetables.map(
    (vegetable) =>
      `
      <li>
        <a href="../../pages/product-detail/index.html?productId=${vegetable.productId} ">
  ...
  const vegetableProducts2 = vegetables2.map(
    (vegetable) =>
      `
      <li>
         <a href="../../pages/product-detail/index.html?productId=${
           vegetable.productId
         } ">
          ${vegetable.productName.match(/^\D+/)}
        </a>
  ...
  const fruitProducts = fruits.map(
    (fruit) =>
      `
      <li>
        <a href="../../pages/product-detail/index.html?productId=${fruit.productId}">
